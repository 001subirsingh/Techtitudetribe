...
<html lang="en">
  ...
  <body>
    ...
    <form action="blogupbackend.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="datetime-local" class="form-control" placeholder="Timestamp" id="time" name="time">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Timestamp" id="writer" name="writer">
      </div>
